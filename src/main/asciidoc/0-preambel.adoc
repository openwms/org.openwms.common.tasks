...
| owms.common.tasks.alreadyExists   | The task exists unexpectedly       | No further action possiblee
| owms.common.tasks.notFoundByPKey  | The task doesn't exist             | No further action possible
| owms.common.tasks.alreadyStarted  | The task is already started        | No further action needed
| owms.common.tasks.alreadyPaused   | The task is already paused         | No further action needed
| owms.common.tasks.isPaused        | The task is unexpected paused      | Start the task again
| owms.common.tasks.isNotPaused     | The task is not paused             | Pause the task first
| owms.common.tasks.notActive       | The task is not active             | Start the task first
| owms.common.tasks.alreadyFinished | The task has already being finished | No further action possible
|===
